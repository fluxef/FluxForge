...
-- 3. Testdaten für 'bla'
-- -----------------------------------------------------
INSERT INTO bla (t_tiny, t_tiny_nn, t_small, t_medium, t_big, t_decimal, t_float, t_double, t_date, t_datetime, t_time, t_year, t_bit)
VALUES (1, 10, 100, 1000, 1000000, 12.34, 1.23, 3.1415, '2023-01-01', '2023-01-01 12:00:00', '12:00:00', 2023, b'00000001'),
       (-1, 20, 0, -100, -5000, 99.99, 0.0, 0.0, '1970-01-01', '1999-12-31 23:59:59.999', '00:00:00', 1901, b'11111111'),
       (NULL, 30, 65535, 8388607, 9223372036854775807, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
       (127, 40, NULL, NULL, -9223372036854775808, -12.50, -0.5, 1.234567, '9999-12-31', '2038-01-19 03:14:07', '23:59:59', 2155, b'10101010'),
...
-- -----------------------------------------------------
INSERT INTO fasel (t_char, t_varchar, t_tinytext, t_text, t_mediumtext, t_longtext, t_binary, t_varbinary, t_blob, t_enum, t_set, t_json)
VALUES ('ABC', 'Standard Text', 'Tiny', 'Das ist ein normaler Text.', 'Medium Content', 'Long Content...', 0x12345600000000000000000000000000, 0xABCDEF, 0xDEADBEEF, 'mittel', 'rot,grün', '{"key": "value", "id": 1}'),
       (NULL, 'Anderer Text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
       ('UNIQUE1', 'Pflichtfeld', 'Test', 'Suche nach Fulltext', 'More data', 'Even more', 0x00000000000000000000000000000000, 0x112233, 0x445566, 'klein', 'blau', '{"active": true, "tags": [1, 2, 3]}'),
       ('MAX', REPEAT('X', 255), 'T', 'Text', 'M', 'L', 0x01000000000000000000000000000000, 0x02, 0x03, 'groß', 'rot,blau', '[1, 2, 3]'),
       ('MIN', '', '', '', '', '', 0x00000000000000000000000000000000, 0x00, 0x00, 'mittel', '', '{}'),
       (NULL, 'Emojis: 🚀🦀', '🦀', 'Rust is cool', '...', '...', NULL, 0x12, 0x34, 'klein', 'grün', '{"lang": "Rust"}'),
       ('123', 'Numbers', '123', '456', '789', '000', 0x31323300000000000000000000000000, 0x343536, 0x373839, 'groß', 'rot,grün,blau', '{"pi": 3.14}'),
       ('EMPTY', 'Empty fields', NULL, '', NULL, '', NULL, NULL, NULL, NULL, 'rot', 'null'),
       ('JSON_TEST', 'JSON Object', 'json', 'content', 'medium', 'long', 0x01000000000000000000000000000000, 0x02, 0x03, 'mittel', 'grün,blau', '{"nested": {"a": 1}}'),
       ('LAST', 'Last entry', 'Ende', 'Over', 'Finish', 'Done', 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF, 0xFF, 0xFF, 'groß', 'blau', '{"status": "ok"}');
