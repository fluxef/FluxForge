...
-- Testdaten für 'foo'
INSERT INTO foo (t_int, t_bigint, t_numeric, t_double, t_date, t_boolean, t_inet) VALUES
                                                                                      (100, 1000000000, 123.45, 3.1415, '2023-01-01', TRUE, '192.168.1.1'),
                                                                                      (200, NULL, NULL, NULL, NULL, FALSE, NULL),
                                                                                      (-1, -500, 0.01, 0.0001, '1999-12-31', TRUE, '2001:db8::1');

-- Testdaten für 'bar'
INSERT INTO bar (t_varchar, t_text, t_int_array, t_text_array, t_jsonb, t_bytea) VALUES
                                                                                     ('Test 1', 'Langer Text', '{1,2,3}', '{"A","B"}', '{"status": "ok", "tags": [1,2]}', '\xDEADBEEF'),
